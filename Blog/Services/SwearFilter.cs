...
namespace ProfanityFilter
{
    ...
    ///
    /// </summary>
    public class SwearFilter : ProfanityBase, IProfanityFilter
    {
        ...
        public SwearFilter(string[] profanityList) : base(profanityList)
        {
            AllowList = new AllowList();
        }
        ...
        public SwearFilter(List<string> profanityList) : base(profanityList)
        {
            AllowList = new AllowList();
        }
